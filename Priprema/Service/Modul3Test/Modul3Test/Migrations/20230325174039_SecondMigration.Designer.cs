...
namespace Modul3TestApp.Migrations
{
    ...
    [Migration("20230325174039_SecondMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modul3Test.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Modul3TestApp.Models.Kurir", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Modul3TestApp.Models.Paket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Modul3Test.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Modul3TestApp.Models.Paket", b =>
                {
                    b.HasOne("Modul3TestApp.Models.Kurir", "Kurir")
                        .WithMany()
